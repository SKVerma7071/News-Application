                        ...
                        <div className="section-inner">
                            <div className="content-wrap row child-cols-12 g-4 lg:g-6" data-uc-grid>
                                    ...
                                    <div className="main-wrap panel vstack gap-3 lg:gap-6">
                                        <div className="block-layout grid-layout vstack gap-2 panel overflow-hidden">
                                            <div className="block-header panel pt-1 border-top">
                                                <h2 className="h6 ft-tertiary fw-bold ls-0 text-uppercase m-0 text-black dark:text-white">Latest</h2>
                                            </div>
                                                            ...
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div className="post-link">
                                                                        <a href="blog-details.html" className="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                                            <span>Read more</span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">Officers have been accused of sexually abusing children over the past two decades, a Post investigation found. Nisi dignissim tortor sed quam sed ipsum ut. Dolor sit amet, consectetur adipiscing elit.</p>
                                                                    <div className="post-link">
                                                                        <a href="blog-details.html" className="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                                            <span>Read more</span>
                                                                        </a>
                                                        ...
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">Children over the past two decades, a Post investigation found. Nisi dignissim tortor sed quam sed ipsum ut. Dolor sit amet, consectetur adipiscing elit.</p>
                                                                    <div className="post-link">
                                                                        <a href="blog-details.html" className="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                                            <span>Read more</span>
                                                                        </a>
                                                        ...
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">Post investigation found. Nisi dignissim tortor sed quam sed ipsum ut. Dolor sit amet, consectetur adipiscing elit.</p>
                                                                    <div className="post-link">
                                                                        <a href="blog-details.html" className="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                                            <span>Read more</span>
                                                                        </a>
                                                        ...
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">Nisi dignissim tortor sed quam sed ipsum ut. Dolor sit amet, consectetur adipiscing elit To spread the word, the company embarked on a mass marketing drive. TV campaigns launched in the platform’s key markets.</p>
                                                                    <div className="post-link">
                                                                        <a href="blog-details.html" className="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                                            <span>Read more</span>
                                                                        </a>
                                                        ...
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">To spread the word, the company embarked on a mass marketing drive. TV campaigns launched in the platform’s key markets. Nisi dignissim tortor sed quam sed ipsum ut. Dolor sit amet, consectetur adipiscing elit.</p>
                                                                    <div className="post-link">
                                                                        <a href="blog-details.html" className="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                                            <span>Read more</span>
                                                                        </a>
                                                        ...
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                <div className="col-auto">
                                                                    <div className="post-media panel overflow-hidden max-w-150px min-w-100px lg:min-w-250px">
                                                                        <div className="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-3x2">
                                                                            <img className="media-cover image uc-transition-scale-up uc-transition-opaque" src="/assets/images/common/img-fallback.png" data-src="/assets/images/demo-seven/posts/img-07.jpg" alt="The Art of Baking: From classNameic Bread to Artisan Pastries" data-uc-img="loading: lazy"/>
                                                                        </div>
                                                                        <a href="blog-details.html" className="position-cover"></a>
                                                                    </div>
                                                                </div>
                                                                <div>
                                                                    <div className="post-header panel vstack justify-between gap-1">
                                                                        <h3 className="post-title h5 lg:h4 m-0 text-truncate-2">
                                                                            <a className="text-none hover:text-primary duration-150" href="blog-details.html">The Art of Baking: From classNameic Bread to Artisan Pastries</a>
                                                                        </h3>
                                                                    </div>
                                                                    <p className="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">To spread the word, the company embarked on a mass marketing drive. TV campaigns launched in the platform’s key markets. Nisi dignissim tortor sed quam sed ipsum ut. Dolor sit amet, consectetur adipiscing elit.</p>
                                                                    <div className="post-link">
                                ...
                                <div className="md:col-3">
                                    <div className="sidebar-wrap panel vstack gap-2 pb-2" data-uc-sticky="end: .content-wrap; offset: 150; media: @m;">
                                        <div className="widget ad-widget vstack gap-2 text-center p-2 border">
                                            <div className="widgt-content">
                                                <a className="cstack max-w-300px mx-auto text-none" href="https://themeforest.net/user/reacthemes/portfolio" target="_blank" rel="nofollow">
                                                    <img className="d-block dark:d-none" src="/assets/images/common/ad-slot-aside.jpg" alt="Ad slot"/>
                                                    <img className="d-none dark:d-block" src="/assets/images/common/ad-slot-aside-2.jpg" alt="Ad slot"/>
                                                </a>
                                            </div>
                                        </div>
                                        <div className="widget popular-widget vstack gap-2 p-2 border">
                                            <div className="widget-title text-center">
                                                <h5 className="fs-7 ft-tertiary text-uppercase m-0">Popular now</h5>
                                            </div>
                                                            ...
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                <div>
                                                                    <div className="hstack items-start gap-3">
                                                                        <span className="h3 lg:h2 ft-tertiary fst-italic text-center text-primary m-0 min-w-24px">1</span>
                                                                        <div className="post-header panel vstack justify-between gap-1">
                                                    ...
                                                    <div>
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                <div>
                                                                    <div className="hstack items-start gap-3">
                                                                        <span className="h3 lg:h2 ft-tertiary fst-italic text-center text-primary m-0 min-w-24px">2</span>
                                                                        <div className="post-header panel vstack justify-between gap-1">
                                                                            <h3 className="post-title h6 m-0">
                                                                                <a className="text-none hover:text-primary duration-150" href="blog-details.html">The Future of Sustainable Living: Driving Eco-Friendly Lifestyles</a>
                                                                            </h3>
                                                    ...
                                                    <div>
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                <div>
                                                                    <div className="hstack items-start gap-3">
                                                                        <span className="h3 lg:h2 ft-tertiary fst-italic text-center text-primary m-0 min-w-24px">3</span>
                                                                        <div className="post-header panel vstack justify-between gap-1">
                                                                            <h3 className="post-title h6 m-0">
                                                    ...
                                                    <div>
                                                        <article className="post type-post panel uc-transition-toggle">
                                                            <div className="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                <div>
                                                                    <div className="hstack items-start gap-3">
                                                                        <span className="h3 lg:h2 ft-tertiary fst-italic text-center text-primary m-0 min-w-24px">4</span>
                                                                        <div className="post-header panel vstack justify-between gap-1">
                                                                            <h3 className="post-title h6 m-0">
                                        ...
                                        <div className="widget social-widget vstack gap-2 text-center p-2 border">
                                            <div className="widgt-title">
                                                <h4 className="fs-7 ft-tertiary text-uppercase m-0">Follow @News5</h4>
                                            </div>
                                            <div className="widgt-content">
                                                <form className="vstack gap-1">
                                                    <input className="form-control form-control-sm fs-6 fw-medium h-40px w-full bg-white dark:bg-gray-800 dark:bg-gray-800 dark:border-white dark:border-opacity-15 dark:border-opacity-15" type="email" placeholder="Your email" required=""/>
                                                    <button className="btn btn-sm btn-primary" type="submit">Sign up</button>
                                                </form>
                                                <ul className="nav-x justify-center gap-1 mt-3">
                                                    <li>
                                                        <a href="#fb" className="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150"><i className="icon icon-1 unicon-logo-facebook"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="#x" className="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150"><i className="icon icon-1 unicon-logo-x-filled"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="#in" className="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150"><i className="icon icon-1 unicon-logo-instagram"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="#yt" className="cstack w-32px h-32px border rounded-circle hover:text-black dark:hover:text-white hover:scale-110 transition-all duration-150"><i className="icon icon-1 unicon-logo-youtube"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
